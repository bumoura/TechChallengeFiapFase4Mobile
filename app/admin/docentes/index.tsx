...
import { LoadingOverlay } from '@/components/LoadingOverlay'; // Importe o Overlay
...
export default function DocentesList() {
  ...
  const [loading, setLoading] = useState(false); // Estado controla o Overlay
    ...
    Alert.alert('Confirmar Exclusão', 'Remover este docente?', [
      ...
      { text: 'Excluir', style: 'destructive', onPress: async () => { 
        ...
        try {
          ...
          await load(data.page); // Recarrega
        } catch (e) {
          Alert.alert('Erro', 'Falha ao excluir.');
          setLoading(false); // Desbloqueia em caso de erro
        }
      }}
    ]);
  };
