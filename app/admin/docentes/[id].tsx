...
export default function EditDocente() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        Alert.alert('Erro', 'Não foi possível carregar os dados do docente.');
        router.back();
      } finally {
        setFetching(false);
      }
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      Alert.alert('Sucesso', 'Dados do docente atualizados!');
      router.back();
    } catch (error) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        <Field name="email" placeholder="Email" label="E-mail Corporativo" />
